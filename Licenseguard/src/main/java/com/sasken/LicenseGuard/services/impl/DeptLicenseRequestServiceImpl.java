...
public class DeptLicenseRequestServiceImpl implements DeptLicenseRequestService {
    ...
    public DeptLicenseRequestServiceImpl(DeptLicenseRequestRepository repo, DepartmentRepository deptRepo) {
        this.repo = repo;
    ...
    public List<DeptLicenseRequestDTO> getRequestsByDepartment(Long departmentId) {
        return repo.findByDepartmentId(departmentId).stream().map(this::mapToDTO).collect(Collectors.toList());
    }
